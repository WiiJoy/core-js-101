...
function timeSpanToString(startDate, endDate) {
  ...
  let hour = parseInt(diffDate / 60 / 60 / 1000, 10);
  let min = parseInt(diffDate / 1000 / 60 - hour * 60, 10);
  let sec = parseInt(diffDate / 1000 - (min + hour * 60) * 60, 10);
  let mlsec = diffDate - (hour * 3600 + min * 60 + sec) * 1000;
